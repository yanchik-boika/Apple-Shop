<!--здесь допиливаю запись данныз в БД-->
<?php
session_start();
...
<head>
    ...
    <title>Buy <?= htmlspecialchars($iphone['name']) ?></title>
...
<main>
    <h2>Your iPhone: <?= htmlspecialchars($iphone['name']) ?></h2>
    ...
    <form id="order-form" action="processOrder.php" method="POST">
        ...
        <label for="storage">Choose the storage of your future iPhone:</label>
        ...
        <label for="color">Choose the color of your future iPhone:</label>
...
<script>
    ...
    function updateSliderImages() {
        var color = document.getElementById('color').value;
        var macBookName = <?= json_encode($iphone['name']) ?>; // Убедитесь, что переменная использует правильное имя устройства
...
<!--это работает, цена отображается все гуд-->
<?php
//session_start();
//$mysqli = new mysqli('localhost', 'root', 'root', 'tryTwo');
//if ($mysqli->connect_error) {
...
<!--        <meta charset="UTF-8">-->
<!--        <meta name="viewport" content="width=device-width, initial-scale=1.0">-->
<!--        <title>Buy --><?php //= htmlspecialchars($iphone['name']) ?><!--</title>-->
<!--        <link rel="stylesheet" href="css/style.css">-->
<!--        <link rel="stylesheet" href="css/buyItem-style.css">-->
<!--    </head>-->
<!--    <body>-->
...
<!--    </header>-->
<!--    <main>-->
<!--        <h2>Your iPhone: --><?php //= htmlspecialchars($iphone['name']) ?><!--</h2>-->
<!--        <img src="image/iPhone1/--><?php //= htmlspecialchars($iphone['image']) ?><!--" alt="none", class="image">-->
<!---->
<!--        <form id="order-form">-->
<!--            <input type="hidden" name="iphone_id" value="--><?php //= $id ?><!--">-->
<!---->
<!--            <label for="storage">Choose the storage of your future iPhone:</label>-->
<!--            <select name="storage" id="storage" required>-->
<!--                --><?php //foreach ($storages as $storage): ?>
<!--                    <option value="--><?php //= htmlspecialchars($storage['storage']) ?><!--">--><?php //= htmlspecialchars($storage['storage']) ?><!--</option>-->
<!--                --><?php //endforeach; ?>
<!--            </select><br>-->
<!---->
<!--            <label for="color">Choose the color of your future iPhone:</label>-->
<!--            <select name="color" id="color" required>-->
<!--                --><?php //foreach ($colors as $color): ?>
<!--                    <option value="--><?php //= htmlspecialchars($color['color']) ?><!--">--><?php //= htmlspecialchars($color['color']) ?><!--</option>-->
<!--                --><?php //endforeach; ?>
<!--            </select><br>-->
<!---->
<!--            <div id="price-display">Price: $<span id="price"></span></div>-->
...
<!--//            xhr.onreadystatechange = function() {-->
<!--//                if (xhr.readyState === 4 && xhr.status === 200) {-->
<!--//                    document.getElementById('price').textContent = xhr.responseText;-->
<!--//                }-->
<!--//            };-->
<!--//            xhr.send('storage=' + encodeURIComponent(storage) + '&color=' + encodeURIComponent(color) + '&iphone_id=' + encodeURIComponent(iphoneId));-->
<!--//        }-->
...
<!--this works with button and getPrice.php-->
<?php
//session_start();
//$mysqli = new mysqli('localhost', 'root', 'root', 'tryTwo');
//if ($mysqli->connect_error) {
...
<!--    <main>-->
<!--        <h2>Your iPhone: --><?php //= htmlspecialchars($iphone['name']) ?><!--</h2>-->
<!--        <img src="image/iPhone1/--><?php //= htmlspecialchars($iphone['image']) ?><!--" alt="none">-->
<!---->
<!--        <form id="order-form">-->
<!--            <input type="hidden" name="iphone_id" value="--><?php //= $id ?><!--">-->
<!---->
...
<!--            </select><br>-->
<!---->
<!--            <button type="button" id="get-price-button">Get Price</button>-->
<!--            <div id="price-display">Price: $<span id="price"></span></div>-->
<!---->
<!--            <button type="submit">Order Now</button>-->
<!--        </form>-->
